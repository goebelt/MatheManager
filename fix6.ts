const fs = require('fs');
let content = fs.readFileSync('C:/Users/Anwender/MatheManager/src/app/invoices/page.tsx', 'utf8');
...
if (content.includes(oldStr)) {
  ...
  fs.writeFileSync('C:/Users/Anwender/MatheManager/src/app/invoices/page.tsx', content);
  console.log('Fixed');
} else {
  console.log('Not found');
  console.log('Context:', content.slice(content.indexOf('findPriceEntry'), content.indexOf('findPriceEntry')+200));
}